...
<Callout type="tip">
**Alternatives**: Due to the [decoupled architecture](/docs/authentication#architecture-decoupled-auth-server), 
...
See [Authentication](/docs/authentication#replacing-the-auth-server-with-managed-services) for details on 
...
<Callout type="info">
**Framework Flexibility**: Due to the [decoupled architecture](/docs/authentication#architecture-decoupled-auth-server), 
